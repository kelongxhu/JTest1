    ...
    public void start()throws Exception{
        client.connect(new InetSocketAddress("127.0.0.1",8000),null,new CompletionHandler<Void,Void>() {
            ...
            public void completed(Void result, Void attachment) {
                try {
                    client.write(ByteBuffer.wrap("this is a testooooooooooooooooo".getBytes())).get();
                    client.write(ByteBuffer.wrap("second message..hello!".getBytes()));
        ...
        client.read(bb, null, new CompletionHandler<Integer,Object>(){
                    ...
                    public void completed(Integer result, Object attachment) {
                        ...
                        System.out.println("read what:"+new String(bb.array()));
                    }
