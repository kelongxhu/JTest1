...
public class ScheduleUtils {
     ...
     */
    public static void getAllJob(Scheduler scheduler) throws SchedulerException {
        ...
        for (JobKey jobKey : jobKeys) {
            ...
            for (Trigger trigger : triggers) {
                ...
                logger.info("任务列表:{},{},{},{}", jobKey.getName(), jobKey.getGroup(), ts.name(), cronExpression);
            }
        }
        ...
        for (JobExecutionContext executingJob : executingJobs) {
            ...
            logger.info("正在执行的任务列表:{},{},{},{}", jobKey.getName(), jobKey.getGroup(), ts.name(), cronExpression);
        }
    }
}
