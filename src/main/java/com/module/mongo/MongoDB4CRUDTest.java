...
public class MongoDB4CRUDTest {
    ...
    public void add2() {
        ...
        DBObject user2 = new BasicDBObject("name", "kelong");
        list.add(user1);
        list.add(user2);
        //添加List集合
        print(users.insert(list).getN());
    ...
    public void remove() {
        queryAll();
        print("删除id = 543b3907e0109046442e2790：" + users.remove(new BasicDBObject("_id", new ObjectId("543b3907e0109046442e2790"))).getN());
    ...
    public void modify() {
        queryAll();
        print("修改：" + users.update(new BasicDBObject("_id", new ObjectId("543b3907e0109046442e2791")), new BasicDBObject("age", 99)).getN());
        queryAll();
