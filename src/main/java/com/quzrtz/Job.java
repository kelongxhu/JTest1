...
public class Job {
    ...
    Logger log = Logger.getLogger(Job.class);
    ...
    public void addJob(ScheduleJob job) throws SchedulerException {
        ...
        if (null == trigger) {
            ...
            trigger =
                TriggerBuilder.newTrigger().startAt(DateUtil.fomartStrToDate("yyyy-MM-dd HH:mm","2015-05-20 15:45")).withIdentity(job.getJobName(), job.getJobGroup()).withSchedule(scheduleBuilder).build();
